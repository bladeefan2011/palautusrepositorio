...
class TestKauppa(unittest.TestCase):
    ...
    def test_poista_korista_palauttaa_tuotteen_varastoon(self):
        ...
        # TARKISTUS
        # Varmistetaan, että kauppa pyytää varastoa palauttamaan tuotteen
